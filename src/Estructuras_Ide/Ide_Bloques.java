...
public class Ide_Bloques {
    
    ArrayList<Ide_bloque> LT_NEXT = new ArrayList<>();
    ArrayList<Boolean> LT_gnext = new ArrayList<>();
    ArrayList<Boolean> LT_gnextLuego = new ArrayList<>();
    
    Ide_bloque next = null;
    ...
    int linea_actual = 0;
    Ide_bloque bloque_actual = null;
    ArrayList<Ide_bloque> Lista = new ArrayList<>();
    ...
    public Ide_bloque obtener_UltimoBlock()
    {
        if(!Lista.isEmpty())
        {
    ...
    public void agregar_AlInicio(String codigoASM, Nodo nodo)
    {
        if(Lista.isEmpty())
        {
            ...
            bloque_actual = new Ide_bloque(nodo.linea,nodo.columna,codigoASM);
