 ...
 * @author antonio
 */
public class Operacion_ALR extends Elemento_C_S{
    
    public Operacion_ALR(Reporte_Tabla_Simbolos global, Reporte_Tabla_Simbolos local) {
        this.tabla = local;
        this.global = global;
    }
          ...
          switch (raiz.nombre) {
            ...
            case "NOT":
                ...
                if (resultado1.tipo.equals("entero")) {
                    ...
                    Principal.reporteError.agregar("Sintactico", raiz.linea, raiz.columna, "Se esperaba 0,1,verdadero o falso");
                ...
                switch (resultado1.tipo) {
                    case "entero":
                        switch (resultado2.tipo) {
                            ...
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No es posible comparar datos numericos con cadenas");
                                break;
                            default:
                                break;
                        }
                    ...
                    case "cadena":
                        switch (resultado2.tipo) {
                            case "entero":
                            case "decimal":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No es posible comparar datos de tipo numerico con cadenas");
                                break;
                            case "booleano":
                ...
                switch (resultado1.tipo) {
                    case "entero":
                        switch (resultado2.tipo) {
                            ...
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No es posible comparar valores tipo numerico con cadenas");
                                break;
                            default:
                                break;
                        }
        ...
        switch (raiz.nombre) {
                ...
                switch (resultado1.tipo) {
                    ...
                    case "booleano":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede sumar datos tipo Bool con Cadenas y Caracteres");
                                break;
                            default:
                        }
                        break;
                    case "caracter":
                        switch (resultado2.tipo) {
                            ...
                            case "booleano":
                            case "caracter":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede sumar datos tipo Caracter con Caracteres y Booleanos");
                                break;
                            case "cadena":
                ...
                switch (resultado1.tipo) {
                    case "entero":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede restar datos tipo entero con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "decimal":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede restar datos tipo Decimal con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "booleano":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede restar datos tipo Bool con Cadenas,Booleanos y Caracteres");
                                break;
                            default:
                        }
                        break;
                    case "caracter":
                        switch (resultado2.tipo) {
                            ...
                            case "booleano":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede restar datos tipo Caracter con Cadenas y Booleanos");
                                break;
                            default:
                        }
                        break;
                    case "cadena":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede restar datos tipo Cadena con cualquier otro tipo de dato");
                                break;
                            default:
                        }
                    default:
                ...
                switch (resultado1.tipo) {
                    case "entero":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede multiplicar datos tipo entero con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "decimal":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede multiplicar datos tipo Decimal con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "booleano":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede multiplicar datos tipo Bool con Cadenas y Caracteres");
                                break;
                            default:
                        }
                        break;
                    case "caracter":
                        switch (resultado2.tipo) {
                            ...
                            case "booleano":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede multiplicar datos tipo Caracter con Cadenas y Booleanos");
                                break;
                            default:
                        }
                        break;
                    case "cadena":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede multiplicar datos tipo Cadena con cualquier otro tipo de dato");
                                break;
                            default:
                        }
                    default:
            ...
            case "DIV":
                try {
                    switch (resultado1.tipo) {
                            ...
                            switch (resultado2.tipo) {
                                case "entero":
                                    try {
                                        ...
                                        Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir un numero por 0 (" + e.toString() + ")");
                                ...
                                case "caracter":
                                    ...
                                    return new Resultado_S(getTipo(valor), valor);
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir datos tipo entero con Cadenas");
                                    break;
                                default:
                            }
                            break;
                        case "decimal":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                    ...
                                    return new Resultado_S(getTipo(valor), valor);
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir datos tipo Decimal con Cadenas");
                                    break;
                                default:
                            }
                            break;
                        case "booleano":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir datos tipo Bool con Cadenas,Booleanos y Caracteres");
                                    break;
                                default:
                            }
                            break;
                        case "caracter":
                            switch (resultado2.tipo) {
                                ...
                                case "booleano":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir datos tipo Caracter con Cadenas y Booleanos");
                                    break;
                                default:
                            }
                            break;
                        case "cadena":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir datos tipo Cadena con cualquier otro tipo de dato");
                                    break;
                                default:
                            }
                        default:
                    ...
                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede dividir un numero con 0");
                }
                    ...
                    switch (resultado1.tipo) {
                        case "entero":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                    ...
                                    return new Resultado_S(getTipo(valor), valor);
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Modulo en datos tipo entero con Cadenas");
                                    break;
                                default:
                            }
                            break;
                        case "decimal":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                    ...
                                    return new Resultado_S(getTipo(valor), valor);
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Modulo en datos tipo Decimal con Cadenas");
                                    break;
                                default:
                            }
                            break;
                        case "booleano":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Modulo en datos tipo Bool con Cadenas,Booleanos y Caracteres");
                                    break;
                                default:
                            }
                            break;
                        case "caracter":
                            switch (resultado2.tipo) {
                                ...
                                case "booleano":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Modulo en datos tipo Caracter con Cadenas y Booleanos");
                                    break;
                                default:
                            }
                            break;
                        case "cadena":
                            switch (resultado2.tipo) {
                                ...
                                case "caracter":
                                case "cadena":
                                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Modulo  en datos tipo Cadena con cualquier otro tipo de dato");
                                    break;
                                default:
                            }
                        default:
                ...
                switch (resultado1.tipo) {
                    case "entero":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Potencia en datos tipo entero con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "decimal":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                                ...
                                return new Resultado_S(getTipo(valor), valor);
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Potencia en datos tipo Decimal con Cadenas");
                                break;
                            default:
                        }
                        break;
                    case "booleano":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Potencia en datos tipo Bool con Cadenas,Booleanos y Caracteres");
                                break;
                            default:
                        }
                        break;
                    case "caracter":
                        switch (resultado2.tipo) {
                            ...
                            case "booleano":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Potencia en datos tipo Caracter con Cadenas y Booleanos");
                                break;
                            default:
                        }
                        break;
                    case "cadena":
                        switch (resultado2.tipo) {
                            ...
                            case "caracter":
                            case "cadena":
                                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se puede usar el operador Potencia en datos tipo Cadena con cualquier otro tipo de dato");
                                break;
                            default:
                        }
                    default:
    ...
    private Resultado_S operacionSimplificada(String tipo, Nodo raiz) {
        ...
        if (raiz.nombre.equals("acceso")) {
            ...
            if (simbolo != null) {
                if (tipo.equals("incremento")) {
                    switch (simbolo.tipo) {
                        ...
                        default:
                            Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "Las operaciones simplificadas solo son validas con datos tipo entero,decimal y caracter");
                            break;
                    }
                } else {
                    switch (simbolo.tipo) {
            ...
            if (resultado.tipo.equals("entero") || resultado.tipo.equals("decimal") || resultado.tipo.equals("caracter")) {
                ...
                Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se pueden realizar operaciones simplificadas sobre datos tipo cadena y bool");
                return new Resultado_S("-1", null);
            }
        }
        return new Resultado_S("-1", null);
                ...
                case "id":
                    ...
                    if (simbolo != null) {
                        if (!simbolo.inicializado) {
                            Principal.reporteError.agregar("Semantico",acceso.linea,acceso.columna,"La variable "+nombre+" no ha sido inicializada");
                        }
                    }
                    if (simbolo != null) {
                        if (simbolo.inicializado) {
