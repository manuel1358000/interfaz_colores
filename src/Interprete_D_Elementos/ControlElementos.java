...
public class ControlElementos extends javax.swing.JFrame {
  ...
  //commit
    ...
    private void jButton_GenerarC3DActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GenerarC3DActionPerformed
        ...
        try {
            ...
            lexico_Dra scan = new lexico_Dra(new BufferedReader( new StringReader(texto)));
            sintactico_Draco parser = new sintactico_Draco(scan);
            parser.parse();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ControlElementos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlElementos().setVisible(true);
            }
        });
    }
