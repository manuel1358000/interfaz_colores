 ...
 * @author antonio
 */
public class Declaraciones_Variables extends Ejecucion_D.Interpretacion {

    public int declaracionEstructuraD(Nodo RAIZ) {
        Nodo listaids = RAIZ.hijos.get(1);
        for (Nodo nodo : listaids.hijos) {
            Simbolo simbolo = Ejecucion_D.Interpretacion.tabla.obtener_Simbolo(nodo.valor, Ejecucion_D.Interpretacion.ambito);
            if (simbolo == null) {
                return 0;
            }
            Simbolo sim_declarado = Ejecucion_D.Interpretacion.tabla.HacerSimboloDeclarado(simbolo);
            if (sim_declarado == null) {
                return 0;
            }

            Simbolo estructura = Ejecucion_D.Interpretacion.tabla.obtener_Estructura(simbolo, new ArrayList<>());
