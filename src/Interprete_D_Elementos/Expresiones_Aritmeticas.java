 ...
 * @author anton
 */
public class Expresiones_Aritmeticas extends Ejecucion_D.Interpretacion{
    Ide_bloque blq1 = null;
    Ide_bloque blq2 = null;
    int    i1   = -1;
    int    i2   = -1;
                ...
                switch(r1.tipo)
                {
                    case "entero":
                        switch(r2.tipo)
                        {
                            ...
                            default:
                                Ejecucion_D.Interpretacion.Lista_Errores.add(raiz.linea, raiz.columna, "Semantico", "Error de tipos entre:" + r1.tipo+"-"+r2.tipo + " operacion:"+raiz.nombre, raiz.archivo);
                                break;
                        }
                    break;    
                    case "decimal":
