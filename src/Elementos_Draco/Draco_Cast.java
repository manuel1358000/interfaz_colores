        ...
        switch (tipo) {
            case "entero":
                switch (resultado.tipo) {
                    ...
                    case "cadena":
                        Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "Un entero no puede ser cadena");
                        break;
                    case "-1":
                        break;
                    default:
            ...
            case "decimal":
                switch (resultado.tipo) {
                    ...
                    case "cadena":
                        Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "Un decimal no puede ser cadena");
                        break;
                    case "-1":
                        break;
                    default:
            ...
            case "caracter":
                switch (resultado.tipo) {
                    ...
                    case "bool":
                    case "cadena":
                        Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "Error al hacer un cast de los elementos cadena-caracter y de bool a decimal");
                        break;
                    case "-1":
                        break;
                    default:
            ...
            case "bool":
                switch (resultado.tipo) {
                    ...
                    case "caracter":
                    case "cadena":
                        Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "Error al castear el dato decimal|caracter|entero|cadena a bool");
                        break;
                    case "-1":
                        break;
                    default:
            ...
            default:
                if (tipo.equalsIgnoreCase(resultado.tipo)) {
                    ...
                    Principal.reporteError.agregar("Semantico", raiz.linea, raiz.columna, "No se pudo realizar el casteo de " + resultado.tipo + " a" + tipo);
                }
                break;
        }
